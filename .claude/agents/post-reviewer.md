...
2. Read the matching reference for the content type: `references/blog-posts.md` (posts), `references/readings.md` (readings), `references/spanish.md` (any `.es.md` file).
