...
Nos hemos encontrado asistiendo a reuniones que parecían una pérdida de tiempo con un "monólogo" difícil de seguir o que no parecía tan interesante como podría ser.
...
Cuando prepares tu presentación, pregúntate:

* ¿Quién asiste a la charla?
* ¿Qué formación tienen?
* ¿Qué posición ocupan?
* ¿Qué información es relevante para ellos?
* ¿Tienen que conocer todas las palabras clave que te gustaría usar?

### Introduce el tema

Crea algo de atmósfera. Intenta responder estas preguntas:

* ¿Por qué deberían escucharte?
* ¿Por qué deberían pasar su tiempo en otra reunión?
* ¿Qué habrán aprendido al final de la charla?
* ¿Cuál es tu mensaje principal?

Cada reunión debería tener un output y un outcome. Tenlo en mente.
...
Resume la(s) conclusión(es) principal(es) de forma concisa:

* ¿Cuál es la conclusión de esta reunión?
...
Si tienes código que presentar, considera:

* Si es una imagen: usa fuentes grandes dentro. Recomiendo usar https://carbon.now.sh/ para snippets simples. O simplemente capturas de pantalla de tu IDE favorito.
* Si programas en vivo: prepara tu editor de antemano. Usa el Modo Presentación de tu IDE.
...
* Muestra interés en el tema. El presentador debería haber dedicado tiempo a preparar las diapositivas para ti.
* Empareja con el presentador el interés del tema. Esto también es responsabilidad del presentador. Ambos deberíais estar ansiosos por aprender más sobre el tema.
...
Al final de la reunión, deberíamos hacernos estas preguntas para mejorar. Pide feedback a otras personas, para que podamos crecer más y juntos.
