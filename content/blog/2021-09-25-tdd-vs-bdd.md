...
[extra]
tldr = "TDD and BDD are different mindsets, not competitors. BDD drives features from the outside, TDD gives you the rhythm inside, and both live off the same feedback loop."
...
[TDD](/blog/test-driven-development/) is not just about the already known "red-green-refactor" mentality, but mostly about the workflow that helps you
...
We ask these questions (and many more) every time, and we do give them an answer as well, but usually without any
...
3. Finally, you **make it better**. Because software is hard and complicated enough to make it right on the first try, so
   [refactoring](/blog/the-art-of-refactoring/) is a must to keep a system healthy. At this point, with a "green running test", you can refactor and
...
up to you, your expectations, and your experience with [testing](/blog/the-art-of-testing/).

![small steps in the tdd feedback loop](/images/blog/2021-09-25/footer.webp)
