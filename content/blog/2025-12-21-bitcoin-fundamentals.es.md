...
1. **Intercambio directo**: Intercambiar bienes por bienes. "Te doy mi pescado por tu pan."
...
¿Qué hace buen dinero? Estas propiedades:

- **Difícil de crear**: No puede ser fácilmente fabricado o falsificado
- **Duradero**: No se deteriora con el tiempo
- **Divisible**: Puede dividirse en piezas más pequeñas
...
- **Un protocolo**: Un conjunto de reglas que las computadoras siguen para acordar quién posee qué
...
- Comisiones: Porcentaje de la transferencia + comisiones fijas
- Requisitos: DNI, prueba de domicilio, cuenta en buen estado

Bitcoin:
- Horario: 24/7/365
- Transferencias globales: ~10 minutos a una hora
- Comisiones: Basadas en tamaño de datos, no cantidad enviada
- Requisitos: Una dirección Bitcoin (gratis, instantánea, sin DNI)
...
- **ETFs de Bitcoin de EE.UU.** aprobados en 2024, trayendo miles de millones en dinero institucional ([fuente](https://www.cnbc.com/2024/01/10/sec-approves-rule-changes-that-pave-the-way-for-bitcoin-etfs.html))
- **Strategy** tiene más de 660.000 BTC como tesorería corporativa, inspirando a otros ([fuente](https://www.strategy.com/purchases))
- **Grandes bancos** ahora ofrecen custodia y trading de Bitcoin a clientes
- **Fondos de pensiones** y gestores de activos están añadiendo Bitcoin a sus carteras
...
- **Square** acepta pagos Bitcoin desde nov. 2025 para más de 4M comerciantes ([fuente](https://squareup.com/us/en/press/block-to-roll-out-bitcoin-payments-on-square))
- **Lightning Network** (LN) procesa millones de pagos instantáneos mensualmente ([fuente](https://lightning.network/))
- **Comerciantes en todo el mundo** aceptan Bitcoin, desde pequeñas tiendas hasta grandes minoristas ([fuente](https://btcmap.org/))

Puedes descartarlo, o puedes entenderlo.
...
La mejor forma de entender Bitcoin es usarlo:

1. **Empieza pequeño**: Compra una pequeña cantidad en una plataforma confiable solo de Bitcoin como:
   - [21bitcoin](https://21bitcoin.app/) o [Relai](https://relai.app/): Apps simples para ahorro automático en Bitcoin
   - [HodlHodl](https://hodlhodl.com/): Trading peer-to-peer, sin custodia
2. **Muévelo a tu propia wallet**: Descarga una wallet móvil y transfiere tu Bitcoin ahí. Siente lo que significa la auto-custodia. Algunas wallets como [BlueWallet](https://bluewallet.io/), [Nunchuk](https://nunchuk.io/).
3. **Envía una transacción**: Envía algunos sats a un amigo. Míralo confirmar en ~10 minutos. Ponte curioso mirando tu transacción en el [mempool](https://mempool.space/).
4. **Prueba Lightning**: Envía un pago instantáneo, casi gratis. Este es el futuro de las transacciones cotidianas. Algunas wallets LN como [Alby Go](https://getalby.com/alby-go), [Muun](https://muun.com/).
...
- [How to Buy Bitcoin Securely](https://cosmevalera.dev/blog/bitcoin-102/) <small>por Cosme - Guía paso a paso</small>
