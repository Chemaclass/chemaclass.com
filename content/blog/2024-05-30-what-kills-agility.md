...
description = "Why Agile if you already do Scrum, Kanban or SAFe? How you manage an organization defines its quality, and what really kills it."
draft = false
[taxonomies]
...
How we manage an organization defines its quality. Excellent management is crucial to avoid the [Waterfall](/blog/what-is-waterfall/) trap if we aim to build an Agile environment. But why would we want that? What's wrong with the way we already work?
...
Controlling and “slow performance” needed a more flexible approach. When people adopt a fixed mindset, they resist change, fear failure, and prioritize rigid processes and hierarchies. This conflicts with Agile's core ideas of embracing change, [continuous delivery](/readings/accelerate/) with iterative development, flexible planning, and fostering collaboration and innovation.
...
Learn the basics of [Extreme Programming](/blog/update-your-team-to-be-more-extreme/) (XP) and Lean Software Development.

- **XP**: Focused on software development practices and technical excellence, with specific practices like [pair programming](/blog/effective-pair-programming/) and [Test-Driven Development](/blog/test-driven-development/) (TDD).
