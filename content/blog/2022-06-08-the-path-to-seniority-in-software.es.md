...
faq = [
  { q = "¿Qué hace senior a un desarrollador?", a = "Los años no. Cómo transmites tu conocimiento, cómo colaboras, cómo haces pair programming, tus habilidades de testing, entregar valor en trozos pequeños, adaptarte al cambio y tu criterio técnico sobre los trade-offs. La tecnología es un detalle de implementación." },
  { q = "¿Experiencia es lo mismo que seniority?", a = "No. Quince años haciendo lo mismo cada día no es lo mismo que cinco años retándote cada semana. Un senior se construye con tiempo, experiencia y actitud, y la actitud es la parte que casi todo el mundo se salta." },
  { q = "¿Por qué el título de senior está inflado?", a = "Porque las empresas necesitan expertos sobre el papel más que en la realidad, y los años en la industria son lo más fácil de medir. En muchos años y varias empresas he visto los fundamentos del software bien interiorizados en torno al 10% de quienes llevan el título." },
  { q = "¿Por dónde se empieza a ser senior?", a = "Enseña esta semana algo que entiendas a otra persona, ofrécete para la tarea que te queda un poco grande y, al terminar cada proyecto, pregúntate qué harías distinto. La seniority se practica, no se concede." },
]
+++
...
En algún momento, después de meses o años, conseguiste tu promoción u otro trabajo, donde ya no eras junior, sino intermedio.
...
La etiqueta de senior está inflada por la necesidad de las empresas de tener expertos en papel más que en la realidad, y es un problema con el que debemos lidiar y del que debemos hablar.
...
- ¿Qué tan bien **transmites tu conocimiento** a otros? Compartir lo que sabes es una tarea esencial para una persona senior.
- ¿Qué tan bien **colaboras** con otras personas, incluyendo al PM/PO y a otros equipos? La colaboración es crucial para crear un bucle de retroalimentación constante.
...
La seniority no se concede, se practica. No esperas el título, construyes el comportamiento hasta que el título te alcanza. Empieza pequeño, y empieza ahora:

- **Enseña lo que sabes.** Elige una cosa que entiendas y explícasela a alguien esta semana. Si no puedes explicarla, aún no la dominas.
- **Busca lo incómodo.** Ofrécete para la tarea que te queda algo grande. El crecimiento vive en el borde de lo que ya sabes hacer.
- **Reflexiona con intención.** Después de cada proyecto, pregúntate qué harías diferente. Experiencia sin reflexión es solo repetición.

El camino no es una promoción. Es la decisión diaria de mejorarte a ti mismo y a quienes te rodean. Hazlo el tiempo suficiente, y el título se vuelve un trámite.
