+++
title = "bashunit"
description = "bashunit: framework de testing para Bash con tests en paralelo, snapshots, dobles de test y data providers. De frustración a open source."
draft = false
[taxonomies]
...
bashunit es un framework de [testing](/es/blog/the-art-of-testing/) ligero y fácil de usar para Bash. Características como testing paralelo y de snapshots, dobles de test, data providers y toneladas de assertions incorporadas.

<!-- more -->

Respaldado por documentación clara y una comunidad activa, se ha convertido en un favorito para testing confiable en Bash. Lo que comenzó como una simple frustración de desarrollo ha crecido hasta convertirse en una herramienta [open-source](/es/blog/open-source-software/) que hace que el testing en Bash sea mucho más fácil y divertido.
...
![nota de la idea de bashunit](/images/blog/2024-10-30/bashunit-idea.webp)
...
En junio de 2024, bashunit fue [integrado en PHPStan](https://bashunit.com/blog/2024-06-21-phpstan-integration) para sus tests end-to-end, permitiendo el uso de las assertions de bashunit independientemente de su runner. Esta flexibilidad resultó ser muy útil.
...
También soporta una amplia gama de [parámetros de línea de comandos](https://bashunit.com/command-line)
y [valores de configuración](https://bashunit.com/configuration). Algunos de mis favoritos incluyen:
...
También proporcionamos [data providers](https://bashunit.com/data-providers) para ejecutar los mismos casos de test con diferentes inputs.

Para [dobles de test](https://bashunit.com/test-doubles), bashunit ofrece mocks y spies. Estos funcionan dentro del mismo proceso que el test, pero actualmente no funcionan entre procesos, un área para mejorar.

Incluye potente [testing de snapshots](https://bashunit.com/snapshots), facilitando la verificación de salidas de comandos o scripts a lo largo del tiempo.

bashunit ofrece un amplio conjunto de [assertions](https://bashunit.com/assertions) nativas para casos de test, incluyendo:
...
Incluso puedes crear tus propias [assertions personalizadas](https://bashunit.com/custom-asserts) para extender las capacidades de bashunit.
