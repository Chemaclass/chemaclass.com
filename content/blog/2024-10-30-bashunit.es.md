...
El 4 de septiembre de 2023 lance la version [0.1](https://github.com/TypedDevs/bashunit/commit/fc9aac40eb8e5ad4483f08d79eb678a3650dcf78): un runner funcional y una unica assertion, `assertEquals`. Luego vino la [0.2](https://github.com/TypedDevs/bashunit/releases/tag/0.2.0), que permitia ejecutar `./bashunit` desde cualquier carpeta. Asi se veia:
