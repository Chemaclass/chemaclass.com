...
- **Compártela a menudo.** La visión no es un documento que se escribe una vez. Da una razón a cada [sprint](/es/readings/zombie-scrum-survival-guide/).
...
- **Planifica alrededor de objetivos.** La planificación de una release conecta varios sprints con un resultado para el cliente. [Scrum](/es/readings/scrum-the-art-of-doing-twice/) pone el ritmo, no el propósito.
...
- **Pide feedback pronto.** [Enseña el trabajo mientras todavía sea barato cambiarlo](/es/blog/ship-show-ask/). Una sprint review es útil cuando cambia la siguiente decisión, no cuando escenifica progreso.
