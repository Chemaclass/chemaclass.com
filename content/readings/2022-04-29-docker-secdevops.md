...
Best practices about how to build docker images and keep a good [security](/blog/verified-git-commits/) layer when running [containers](/readings/accelerate/) as well, from the docker daemon and all tech behind docker.
