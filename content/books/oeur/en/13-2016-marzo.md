...
It seems that that mountain had a surprise in store for us. Or, instead, we were the ones who invented that uncontrolled surprise with an entirely different — as well as rewarding — ending from what we, on that misguided day, set out to achieve. Reason enough for joy from that day to our now.
