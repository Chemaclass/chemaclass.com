...
const SERVICE_SEARCH_CONTENT = {
    en: {
        "/services/web-development/": "Website design and development for small businesses and independent professionals. Hire one senior developer in Berlin. What a website costs: fixed price from €1,000, live in under a month. Two tiers: Custom Website and Website + Blog. Responsive design, SEO fundamentals, HTTPS, hosting and domain included for year 1, optional care plan.",
    ...
    es: {
        "/services/web-development/": "Diseño y desarrollo de páginas web para empresas y autónomos, hecho por un desarrollador senior en Berlín. Cuánto cuesta una página web y cómo contratar sin agencia. Precio cerrado desde 1.000 €, online en menos de un mes. Dos opciones: Web a Medida y Web + Blog. Diseño responsive, SEO básico, HTTPS, hosting y dominio incluidos el primer año, plan de mantenimiento opcional.",
